...
<html>
<head>
<title><spring:message code="Computer database" /></title>
...
<body>
		...
		<div class="dropdown ">
			...
			<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
				<a class="dropdown-item" href="?lang=fr"><spring:message
						code="label.french" /></a> <a class="dropdown-item" href="?lang=en"><spring:message
	...
	<div class="container">
		...
		<h1 id="homeTitle">${noOfPcs}&nbsp;<spring:message
		...
		<table class="table table-striped table-bordered">
			<thead>
				<tr>
					...
					<th><a
						href="dashboard?order=computer&search=${search}&currentPage=${previousPage}&pcsPerPage=${pcsPerPage}"
						onclick=""><spring:message code="label.computerName" /></a></th>
					<th><a
						href="dashboard?order=introduced&search=${search}&currentPage=${previousPage}&pcsPerPage=${pcsPerPage}"
					...
					<th><a
						href="dashboard?order=company&search=${search}&currentPage=${previousPage}&pcsPerPage=${pcsPerPage}"

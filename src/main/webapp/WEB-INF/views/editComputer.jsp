	...
	<div class="container">
		...
		<div class="dropdown ">
			...
			<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
				<a class="dropdown-item" href="?lang=fr&computerId=${computer.id}"><spring:message
						code="label.french" /></a> <a class="dropdown-item" href="?lang=en&computerId=${computer.id}"><spring:message
